...
<div>
    <div class="container mt-8">
        <div class="bg-white rounded-2xl border border-[#0072BB]">
            <div class="relative">
                <img src="{{ $category->getFirstMedia(Category::MEDIA_CATEGORY)?->getUrl() }}" alt="" class="lg:max-h-[340px] lg:h-[340px] h-[180px] max-h-[180px] w-full object-cover object-center rounded-xl">
