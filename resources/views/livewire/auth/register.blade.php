    ...
    <form wire:submit.prevent="submit">
            ...
            <div class="flex items-center gap-2 border-b-2 border-gray-300 ps-2">
                <svg width="11" height="12" viewBox="0 0 11 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_453_64)">
                        <path d="M5.49857 6.13653C7.14284 6.13653 8.47578 4.76282 8.47578 3.06827C8.47578 1.37371 7.14284 0 5.49857 0C3.8543 0 2.52136 1.37371 2.52136 3.06827C2.52136 4.76282 3.8543 6.13653 5.49857 6.13653Z" fill="#979797" />
                        <path d="M0 11.9998C0 8.86983 2.46154 6.33301 5.49858 6.33301C8.53561 6.33301 10.9972 8.86983 10.9972 11.9998H0Z" fill="#979797" />
                    </g>
                    <defs>
                ...
                <x-auth-input wire:model="name" id="name" class="block w-full" type="text" name="name" placeholder="{{ __('messages.Name') }}" :value="old('name')" required autofocus autocomplete="name" />
            </div>
        ...
        <div class="mt-3">
            <div class="flex items-center gap-2 border-b-2 border-gray-300 ps-2">
                ...
                <x-auth-select wire:model="country_code" class="w-1/3">
        ...
        <div class="mt-3">
            <div class="flex items-center gap-2 border-b-2 border-gray-300 ps-2">
                ...
                <x-auth-input wire:model="phone_number" id="phone_number" class="block w-full" type="tel" name="phone_number" placeholder="{{ __('messages.Phone number') }}" minlength="8" maxlength="12" required autofocus autocomplete="phone_number" />
            </div>
        ...
        <div class="flex items-center justify-center mt-4">
            <x-primary-button wire:click.prevent="submit" class="px-5 py-3 mt-7">
