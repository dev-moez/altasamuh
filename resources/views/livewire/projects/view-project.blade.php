        ...
        <div class="container">
            ...
            <div class="grid grid-cols-1 gap-2 p-3 bg-white rounded-md lg:p-5 lg:gap-4 lg:grid-cols-2">
                <div>
                    ...
                    <img src="{{ $project->getFirstMedia(Project::MEDIA_COLLECTION)?->getUrl() }}" alt="" class="lg:max-w-full lg:h-[420px] lg:max-h-[512px]  w-full h-[280px]  rounded-md object-cover">
