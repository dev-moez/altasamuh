    ...
    <form wire:submit.prevent="submit">
        <div class="mt-3">
            <div class="flex items-center gap-2 border-b-2 border-gray-300 ps-2">
                ...
                <x-auth-input id="phone_number" class="block w-full" type="tel" name="phone_number" placeholder="{{ __('messages.Phone number') }}" :value="old('phone_number')" required autofocus autocomplete="phone_number" />
            </div>
        ...
        <div class="mt-3">
            <div class="flex items-center gap-2 border-b-2 border-gray-300 ps-2">
                ...
                <x-auth-input id="password" class="block w-full" type="password" name="password" placeholder="{{ __('messages.Password') }}" :value="old('password')" required />
            </div>
