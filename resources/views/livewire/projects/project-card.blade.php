<div>
    <div class="border-2 border-gray-200 rounded-md ">
        ...
        <div class="px-3 pt-4 pb-6 bg-white">
            ...
            <div class="my-3">
                <p class="text-end">{{ $donationsPercentage }} ٪</p>
                <!-- Progress -->
                <div class="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-neutral-700" role="progressbar" aria-valuenow="{{ $donationsPercentage }}" aria-valuemin="0" aria-valuemax="100">
                    <div class="flex flex-col justify-center overflow-hidden text-xs text-center text-white transition duration-500 bg-yellow-500 rounded-full whitespace-nowrap dark:bg-yellow-500" style="width: {{ $donationsPercentage }}%"></div>
                </div>
                <!-- End Progress -->
            </div>
            ...
            <div class="flex items-center justify-between gap-4 mt-5">
                ...
                <div class="inline-block px-3 py-2 bg-white border border-gray-200 rounded-lg" data-hs-input-number="">
                    <div class="flex items-center gap-x-1.5">
                        ...
                        <input wire:model="amount" class="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" style="-moz-appearance: textfield;" type="number" aria-roledescription="Number field" value="0" data-hs-input-number-input="">
            ...
            {{-- Actions --}}
            <div class="flex flex-col flex-grow gap-4 my-4 lg:flex-row">
